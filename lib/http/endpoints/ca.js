...
function addRequest(req, res) {
  ...
  castHttp.acceptBodyString(req, MAX_CSR_BYTES, function(err, body) {
    if (err) {
      ...
      castHttp.returnJob(res, control.ca.addRequest(hostname, body));
    }
  });
}
...
function signRequest(req, res) {
  ...
  castHttp.returnJob(res, control.ca.signRequest(hostname));
}
...
function deleteRequest(req, res) {
  ...
  castHttp.returnJob(res, control.ca.deleteRequest(hostname));
}
