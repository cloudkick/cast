...
function register(app, apiVersion) {
  // @TODO: Expose follow functionality over http:
  // - add a check
  // - schedule / resume a check
  // - unschedule / pause a check
  // - remove check
  app.get('/', listAllChecks);
  app.get('/scheduled/', listScheduledChecks);
  app.get('/:checkId/', checkDetails);
}
