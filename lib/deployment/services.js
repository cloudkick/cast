...
var create_service = function(instance_name, instance_path, application_type, callback) {
  var runit = get_service_dir();

  runit_templates.get_application_template(instance_name, instance_path, application_type, function(error, template) {
    if (error) {
