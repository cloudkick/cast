...
/**
 * Get the name of the bundle used by an instance
 *
 * @param {Function} callback Callback which is called with (err, bundlename)
 */
Instance.prototype.get_bundlename = function(err, callback) {
  var self = this;
  if (self._bundlename) {
...
Instance.prototype.prepare_version = function(version, callback) {
  ...
  async.series([
    ...
    function(callback) {
      ...
      manifest.get_manifest_obj(manifest_path, true, function(err, manifest_obj_) {
