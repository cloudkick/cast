...
Instance.prototype.get_bundle_name = function(callback) {
  ...
  if (self._bundle_name) {
    ...
    fs.readlink(bundle_link_path, function(err, target) {
      ...
      callback(err, self._bundle_name);
      return;
    });
  }
};
...
Instance.prototype.get_bundle_version_path = function(version, callback) {
  ...
  self.get_bundle_name(function(err, bundle_name) {
    ...
    callback(err, bundle_version_path);
    return;
  });
};
...
Instance.prototype.activate_version = function(version, callback) {
  ...
  async.series([
    ...
    function(callback) {
      hooks.execute(self, version, 'pre_version_activate', null, [version, new_version_path],
                    callback);
    },
    ...
    function(callback) {
      hooks.execute(self, version, 'post_version_activate', null, [version, new_version_path],
                    callback);
    }
  ], callback);
};
...
exports.create_instance = function(instance_name, bundle_name, bundle_version, callback) {
  ...
  async.series([
    ...
    async.apply(fs.symlink, path.resolve(extracted_bundle_root), instance_bundle_link),
