 ...
 * @param {Function} callback     A callback fired with (err).
 */
createInstance = function(instanceName, bundleName, bundleVersion, callback) {
...
upgradeInstance = function(instanceName, bundleVersion, callback) {
  var instance;
 ...
 */
getInstance = function(instanceName, callback) {
