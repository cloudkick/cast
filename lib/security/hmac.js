 ...
 */
exports.createHttpHmac = function(method, url, headers)
{
  ...
  headers[signatureHeader] = hmacGenreate(inputs);
};


exports.validateHttpHmac = function(method, url, headers)
{
  var inputs = [method, url];
  ...
  var expected = hmacGenreate(inputs);
