...
var generateHmac = function(input) {
  var conf = config.get();
 ...
 */
var createHttpHmac = function(method, url, headers) {
...
var validateHttpHmac = function(method, url, headers) {
  var inputs = [method, url];
