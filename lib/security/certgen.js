 ...
 */
exports.selfsigned = function(hostname, outputKey, outputCert, cb)
{
  var cmd = sprintf("openssl req -batch -x509 -nodes -days 1825 -subj '/CN=%s' -sha1 -newkey rsa:2048 -keyout %s -out %s",
                     hostname, outputKey, outputCert);
