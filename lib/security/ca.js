...
/**
 * TODO: Make __very__ sure that no one can ever upload to (or retrieve from)
 * a path outside of the 'outdir' or overwrite anything in it. The first two
 * of these might be best implemented with a more robust URL handler on the
 * REST API, as we run into this in a few places.
 */
