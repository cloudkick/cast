...
function SigningRequest(name) {
  ...
  this.parentDir = config.get()['ssl_ca_outdir'];
}
 ...
 */
SigningRequest.prototype.getCSRPath = function(hostname) {
 ...
 */
SigningRequest.prototype.getCRTPath = function(hostname) {
 ...
 */
SigningRequest.prototype.getRequestText = function(hostname, callback) {
 ...
 * @param {Function} callback Callback fired with (err, text).
 */
SigningRequest.prototype.getCertificateText = function(hostname, callback) {
