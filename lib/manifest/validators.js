 ...
 */
var isValidType = function(value, options, callback) {
...
var isValidString = function(value, options, callback) {
...
var isValidNumber = function(value, options, callback) {
...
var isValidPort = function(value, options, callback) {
...
var isValidCheck = function(value, options, callback) {
...
var isValidTemplate = function(value, options, callback) {
  if (!value) {
    callback(new Error('Template file is an empty string'));
    return;
  }

  var templatePath = path.join(options.manifestPath, value);
...
var isValidDataFile = function(value, options, callback) {
...
var isValidTemplateVariable = function(value, options, callback) {
  var item;
 ...
 */
exports.validateArray = function(array, validator, options, callback) {
 ...
 *                            is present if errors happened.
 */
exports.validateValue = function(value, validator, options, callback) {
