...
var is_valid_check = function(value, options, callback) {
  ...
  index = misc.array_find(check_name,
                          health.available_checks,
                          null,
  ...
  if (index === false) {
    callback(new Error(sprintf('Invalid check type: %s', check_name)));
    return;
  }
 ...
 */
exports.validate_array = function(array, validator, options, callback) {
 ...
 *                            is present if errors happened.
 */
exports.validate_value = function(value, validator, options, callback) {
