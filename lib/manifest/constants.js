...
var COMMON_FIELDS = {
  ...
  'type':             {'type': 'array', 'required': true, 'validator': 'valid_type', 'description': 'Application type'},
  ...
  'data_files':       {'type': 'array', 'required': true, 'validator': 'valid_string', 'description': 'List of relative paths to files and directories which are modified or created during application run-time (e.g. database file, user uploaded files, etc.)'}
};
 ...
 */
var DEFAULT_VALUES = {
  'node_js': {'entry_file': 'server.js', 'open_ports': [80]},
 ...
 */
var HEALTH_CHECKS = {
  'nodejs': [{'type': 'HTTPCheck', 'arguments': {'ip_address': '127.0.0.1', 'port': '80'}}],
  'shell': [],
};
