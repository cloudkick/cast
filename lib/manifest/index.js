 ...
 */
exports.validateManifest = function(manifestPath, callback) {
  exports.getManifestObject(manifestPath, true, function(error, manifestObject) {
    if (error) {
      callback(error, null);
      return;
    }
 ...
 *                            with manifest_object as the second argument otherwise.
 */
exports.getManifestObject = function(manifestPath, mergeWithDefaults, callback) {
