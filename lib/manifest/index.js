...
var validate_manifest = function(manifest_path, callback) {
  exports.get_manifest_data_as_object(manifest_path, true, function(error, manifest_object) {
    if (error) {
 ...
 *                            with manifest_object as the second argument otherwise.
 */
var get_manifest_data_as_object = function(manifest_path, merge_with_defaults, callback) {
...
exports.get_manifest_data_as_object = get_manifest_data_as_object;
