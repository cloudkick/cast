...
BundleManager.prototype.init = function(callback) {
  ...
  function ensureBundleRoot(callback) {
    fsutil.ensureDirectory(self.bundleRoot, callback);
  }

  function ensureExtractedRoot(callback) {
    fsutil.ensureDirectory(self.extractedRoot, callback);
  }

  async.parallel([ensureBundleRoot, ensureExtractedRoot], callback);
};
