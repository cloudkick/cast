...
var getCommandOptions = function(command, subCommand, commandParser) {
  ...
  var requiredArguments, optionalArguments;
  ...
  return { 'required_arguments': commandModule.config.requiredArguments,
           'optional_arguments': commandModule.config.optionalArguments,
