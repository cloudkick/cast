...
function makePathRelative(file, root, requireFile, cb)
{
...
exports.handleCommand = function(args)
{
  ...
  var manifestPath, tmppath, entryPath, templates, data_files;
  var manifest = {};
  ...
  async.waterfall([
    ...
    function(callback) {
      makePathRelative(args.entry_file, apppath, true, function(err, file) {
        entryPath = file;
        callback(err);
        return;
      });
