  ...
  async.series([
    ...
    function(callback) {
      process.nextTick(function(){
        ...
        sys.puts("Uploading to " + remotepath);
        ...
        /*
        pumpfile.pumpfileout(fpath, request, function(err) {
          pbar.end();
          if (err) {
            err = new Error("An error occurred while sending the bundle");
          }
          return callback(err);
        },
        function(bytes) {
        ...
        */
        ...
        var fstream = fs.createReadStream(fpath, {'bufferSize': 512});
        var errstate = false;
