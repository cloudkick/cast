...
exports.run = function() {
  ...
  p.add_commands(['init']);
  p.add_commands(['bundles/list', 'bundles/create', 'bundles/validate-manifest', 'bundles/upload']);
  p.add_commands(['instances/create', 'instances/destroy']);
  p.add_commands([
    'services/list',
    'services/enable',
    'services/disable',
  ...
  p.add_commands(['remotes/add', 'remotes/list', 'remotes/set-default']);
  p.add_global_options(GLOBAL_OPTIONS);
  ...
  config.setup_client(function(err) {
    if (err) {
