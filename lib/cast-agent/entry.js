...
var requirements = {
  ...
  'runsvdir_running': [null, req.isDefined,
   ...
   'gnutar': [null, req.isDefined, 'You need to have GNU tar installed to use Cast. ' +
              'On Mac OS X you can install "gnutar" port, on FreeBSD you can install ' +
              '"gtar" port and on Ubuntu you can install "gpg" package. For more detailed ' + 
              'instruction please visit the documentation at http://www.cast-project.org/start/.']
};
