 ...
 */
function createSigningRequest(name, csrText) {
 ...
 * @returns {jobs.Job} The job.
 */
function signSigningRequest(name) {
...
exports.createSigningRequest = createSigningRequest;
exports.signSigningRequest = signSigningRequest;
