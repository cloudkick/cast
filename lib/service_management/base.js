 ...
 */
SupervisedService.prototype.getDetails = function(callback) {
 ...
 */
SupervisedServiceManager.prototype.createService = function(serviceName, servicePath, entry_file, callback) {
  throw new Error('Not implemented');
};
 ...
 */
SupervisedServiceManager.prototype.listServicesDetails = function(callback) {
  throw new Error('Not implemented');
};
