...
var getTemplate = function(templateArgs, callback) {
  var i;
  var requiredArgs = ['instance_path', 'entry_file'];
  ...
  var entry_file = templateArgs.entry_file;
  ...
  norris.get(function(facts) {
    ...
    var entryPath = path.join(instancePath, entry_file);
    var runCmd = sprintf('%s %s', facts.nodeBinary, entryPath);
