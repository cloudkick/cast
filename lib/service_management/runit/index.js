 ...
 */
RunitService.prototype.getDetails = function(cb) {
  var self = this;
  var status;
  var details = {};
 ...
 */
RunitService.prototype.isEnabled = function(cb) {
  path.exists(this.pathEnabled, cb);
};
 ...
 *                      a status object.
 */
RunitService.prototype._GetStatus = function(cb) {
  var sstatus = {};
...
RunitService.prototype.enable = function(cb) {
  ...
  self.isEnabled(function(enabled) {
    if (!enabled) {
      ...
      return fs.symlink(target, self.pathEnabled, cb);
    }
    return cb();
  });
};
...
RunitService.prototype.disable = function(cb) {
  ...
  self.isEnabled(function(enabled) {
    if (enabled) {
      return fs.unlink(self.pathEnabled, cb);
    }
    return cb();
  });
};
 ...
 */
RunitServiceManager.prototype.listServicesDetails = function(cb) {
  var self = this;
  var services = [];
 ...
 */
var getManager = function(pathAvailable, pathEnabled) {
