 ...
 */
exports.getValidBundleName = function(text) {
 ...
 */
exports.isValidBundleVersion = function(version) {
 ...
 */
exports.getFullBundleName = function(bundleName, bundleVersion) {
 ...
 *
 * @param {String} full_bundle_name Bundle name as returned by the get_full_bundle_name function.
 * @return {String} Bundle name.
 */
exports.getBundleName = function(fullBundleName) {
  var splitted, bundleName;

  splitted = fullBundleName.split('@');

  if (splitted.length !== 2) {
    throw new exports.Errorf('Could not extract bundle name from the provided string: %s', fullBundleName);
  }
 ...
 */
exports.getValidInstanceName = function(fullBundleName, instanceNumber) {
 ...
 */
exports.inArray = function(needle, haystack, strict, compareFunction) {
  return (exports.arrayFind(needle, haystack, strict, compareFunction) !== false);
};
 ...
 */
exports.arrayFind = function(needle, haystack, strict, compareFunction) {
 ...
 */
exports.arraysContainsSameElements = function(array1, array2, strict) {
  var compare;
  ...
  function compareLoose(index) {
    return (exports.inArray(array1[index], array2));
  }
 ...
 */
exports.arrayIsSubsetOf = function(array1, array2, strict) {
  if (array1.length > array2.length) {
    return false;
  }
  ...
  for (var i = 0; i < array1.length; i++) {
    if (!exports.inArray(array1[i], array2)) {
      return false;
    }
  }
 ...
 */
exports.arrayDifference = function(array1, array2) {
  var difference = [];
 ...
 */
exports.filterRepeatedPaths = function(paths) {
  var path;
  var pathsFiltered = [];
  ...
  for (var i = 0; i < pathsCount; i++) {
    ...
    if (!exports.inArray(path, pathsFiltered, null, compareFunction)) {
