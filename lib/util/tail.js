 ...
 */
var tail_file = function(file_path, bytes_to_read, follow, callback) {
  var read_file, unsubscribe;
  var stat;
   ...
   */
  read_file = function(start, end) {
    var file_stream = fs.createReadStream(file_path, {start: start, end: end});
