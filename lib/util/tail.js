...
/**
 * Return bytes_to_read bytes of data from the end of the file and calls the provided callback with the new data
 ...
 *                              and the unsubscribe function as the third one.
 */
tail_file = function(file_path, bytes_to_read, callback) {
