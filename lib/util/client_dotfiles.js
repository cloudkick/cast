...
exports.getProjectBundleRoot = function(projectRoot) {
  return path.join(exports.dot_cast_project_path(projectRoot), 'tmp');
};
...
exports.ensure_dot_cast_project = function(projectpath, callback) {
  ...
  fsutil.ensure_directory(dot_cast_project_path, function(err) {
    callback(err, dot_cast_project_path);
    return;
  });
};
...
exports.get_bundle_path = function(project_root, bundle_name) {
  ...
  return path.join(exports.getProjectBundleRoot(project_root), bundle_file);
};
...
exports.list_bundles = function(project_root, callback) {
  ...
  var bundledir = exports.getProjectBundleRoot(project_root);
