...
exports.ensure_dot_cast = function(cb) {
  fsutil.ensure_directory(dot_cast, cb);
};
 ...
 * @param {Function} cb A callback fired upon completion with (err, dot_cast_project_path)
 */
exports.ensure_dot_cast_project = function(projectpath, cb) {
  ...
  fsutil.ensure_directory(dot_cast_project_path, function(err) {
    return cb(err, dot_cast_project_path);
  });
};
