 ...
 *
 * @param {?Object} headers Request headers. content-length is automatically
 *                          added if data is provided.
 * @param {?String} data Optional data which is sent in the request.
 * @param {Function} callback A callback called with (err, res)
 */
function postRequest(remoteUrl, headers, data, callback) {
  headers = headers || {};
  var parsed, defaultPort, module;
