 ...
 */
exports.getStylesLength = function(string) {
...
exports.lpad = function(str, width) {
  ...
  str = String(str);
  stylesLength = exports.getStylesLength(str);
 ...
 *                        {String} valueProperty - name of the property in the rows object which holds the value for this column
 ...
 *                        {Function} formatFunction* - a function which is applied for each value of this column.
 *
 * @param {Array} rows Array of objects which hold the values for each column.
 * @param {String} noDataText The text which is printed to standard output if the rows array is empty.
 */
exports.printTable = function(columns, rows, noDataText) {
  ...
  if (rows.length === 0) {
    ...
    columns.forEach(function(column) {
      ...
      string = exports.lpad(columnTitle, paddingLeft);
      string = exports.rpad(string, column.paddingRight);
    ...
    rows.forEach(function(row) {
      columns.forEach(function(column) {
        ...
        if (column.hasOwnProperty('formatFunction')) {
          value = column.formatFunction.call(null, value);
        }

        string = exports.lpad(value, column.paddingLeft);
        string = exports.rpad(string, column.paddingRight);
 ...
 */
exports.printWrapped = function(text, width, indent, outputFunction) {
  var chunk, stylesLength, splitIndex, remaining, indentstr;
  width = width || 80;
  indent = indent || 2;
  outputFunction = outputFunction || sys.puts;
  stylesLength = exports.getStylesLength(text);
 ...
 */
exports.prompt = function(question, validOptions, defaultOption, callback) {
...
*/
exports.formatTags = function(string, replaceFunction) {
  var stylized = string;
...
exports.stylize = function(string) {
  var replaceFunction = function(str, p1, p2, p3) {
    return sprintf('\033[%sm%s\033[%sm', styles[p2][0], p3, styles[p2][1]);
  };

  return exports.formatTags(string, replaceFunction);
};
...
*/
exports.stripStyles = function(string) {
  var replaceFunction = function(str, p1, p2, p3) {
    return sprintf('%s', p3);
  };
...
exports.puts = function() {
  ...
  for (var i = 0; i < arguments.length; i++) {
    if (supportsStyles) {
      ...
      sys.puts(exports.stripStyles(arguments[i]));
    }
  }
};
