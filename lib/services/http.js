...
function index(req, res) {
  http.return_json(res, 200, { 'services': constants.APPS });
}
...
exports._serverOnly = function(services_http_root, apps, current_api_version) {
  ...
  services_http_root = services_http_root || constants.SERVICES_HTTP_ROOT;
  apps = apps || constants.APPS;
  current_api_version = current_api_version || constants.CURRENT_API_VERSION;
