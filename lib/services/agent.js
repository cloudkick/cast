...
var WorkerPool = require('extern/node-worker/index').workerPool.WorkerPool;
...
Agent.prototype.start = function(port, host) {
  ...
  this._EndpointPort = port || config.get().agentEndpointPort;
  this._EndpointHost = host || config.get().agentEndpointHost;
...
constants.INCOMING_COMMAND_MAPPING.runCheck.handler = Agent.prototype.handleCmdRunCheck;
